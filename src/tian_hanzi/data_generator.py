...
# -*- coding: utf-8 -*-
"""
HSK-Based Deck Data Generator

Extracts data from HSK vocabulary lists to create:
1. Vocabulary words from specified HSK levels
2. All hanzi characters used in those words
3. Productive components/radicals used in those hanzi
"""
...
try:
    ...
    raise ImportError(
        "hanzipy is not installed. Install with: pip install hanzipy"
    )
...
try:
    ...
    raise ImportError(
        "strokes library is not installed. Install with: pip install strokes"
    )

from .utils.pinyin_converter import numbered_to_accented
